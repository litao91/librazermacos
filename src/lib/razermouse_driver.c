...
static int razer_get_report(IOUSBDeviceInterface **usb_dev,
  ...
  case USB_DEVICE_ID_RAZER_OROCHI_V2_BLUETOOTH:
    return razer_get_usb_response(usb_dev, index, request_report, index,
                                  response_report,
                                  RAZER_ATHERIS_RECEIVER_WAIT_MIN_US);
    break;
  ...
  case USB_DEVICE_ID_RAZER_DEATHADDER_V2_PRO_WIRED:
    return razer_get_usb_response(usb_dev, index, request_report, index,
                                  response_report,
                                  RAZER_VIPER_MOUSE_RECEIVER_WAIT_MIN_US);
    break;
...
razer_send_payload(IOUSBDeviceInterface **usb_dev,
                   struct razer_report *request_report) {
  IOReturn retval = -1;
  ...
  if (retval == 0) {
    ...
    if (response_report.remaining_packets !=
      ...
      printf("Contents of request_report are:\ncommand_class: "
             "%#04X\ncommand_id: %#04X\ntransaction_id: %#04X\n\n",
             (unsigned int)request_report->command_class,
             (unsigned int)request_report->command_id.id,
             (unsigned int)request_report->transaction_id.id);
...
ssize_t razer_attr_write_side_mode_wave(IOUSBDeviceInterface **usb_dev,
  ...
  case USB_DEVICE_ID_RAZER_BASILISK_V3:
    report = razer_chroma_extended_matrix_effect_wave(
        VARSTORE, BASILISK_V3_BASE_LED, direction, 0x28);
    report.transaction_id.id = 0x1f;
    break;
  default:
...
ssize_t razer_attr_write_side_mode_static(IOUSBDeviceInterface **usb_dev,
                                          const char *buf, size_t count,
                                          int side) {
  struct razer_report report = {0};
  ...
  if (count == 3) {
    ...
    case USB_DEVICE_ID_RAZER_NAGA_HEX_V2:
      report = razer_chroma_mouse_extended_matrix_effect_static(
          VARSTORE, side, (struct razer_rgb *)&buf[0]);
      break;
    ...
    case USB_DEVICE_ID_RAZER_BASILISK_V3:
      report = razer_chroma_extended_matrix_effect_static(
          VARSTORE, BASILISK_V3_BASE_LED, (struct razer_rgb *)&buf[0]);
      report.transaction_id.id = 0x1f;
      break;
...
ssize_t razer_attr_write_side_mode_static_no_store(
    IOUSBDeviceInterface **usb_dev, const char *buf, size_t count, int side) {
  struct razer_report report = {0};
  ...
  if (count == 3) {
    ...
    case USB_DEVICE_ID_RAZER_NAGA_HEX_V2:
      report = razer_chroma_mouse_extended_matrix_effect_static(
          NOSTORE, side, (struct razer_rgb *)&buf[0]);
      break;
    ...
    default:
      printf("razermouse: side_mode_static_no_store not supported for this "
             "model\n");
      return count;
    }
...
ssize_t razer_attr_write_side_mode_spectrum(IOUSBDeviceInterface **usb_dev,
                                            const char *buf, size_t count,
                                            int side) {
  struct razer_report report = {0};
...
ssize_t razer_attr_write_side_mode_breath(IOUSBDeviceInterface **usb_dev,
                                          const char *buf, size_t count,
                                          int side) {
  struct razer_report report = {0};
  ...
  case USB_DEVICE_ID_RAZER_NAGA_HEX_V2:
    ...
    case 3: // Single colour mode
      report = razer_chroma_mouse_extended_matrix_effect_breathing_single(
          VARSTORE, side, (struct razer_rgb *)&buf[0]);
      break;

    case 6: // Dual colour mode
      report = razer_chroma_mouse_extended_matrix_effect_breathing_dual(
          VARSTORE, side, (struct razer_rgb *)&buf[0],
          (struct razer_rgb *)&buf[3]);
      break;

    default: // "Random" colour mode
      report = razer_chroma_mouse_extended_matrix_effect_breathing_random(
          VARSTORE, side);
      break;
    }
    break;
  ...
  case USB_DEVICE_ID_RAZER_DEATHADDER_V2_MINI:
    ...
    default: // "Random" colour mode
      report =
          razer_chroma_extended_matrix_effect_breathing_random(VARSTORE, side);
      break;
    }
    break;
  }
...
ssize_t razer_attr_write_side_mode_none(IOUSBDeviceInterface **usb_dev,
                                        const char *buf, size_t count,
                                        int side) {
  struct razer_report report = {0};
 ...
 */
ssize_t razer_attr_write_logo_mode_wave(IOUSBDeviceInterface **usb_dev,
                                        const char *buf, size_t count) {
  unsigned char direction = (unsigned char)strtol(buf, NULL, 10);
  struct razer_report report = {0};
  ...
  case USB_DEVICE_ID_RAZER_BASILISK_ULTIMATE:
  case USB_DEVICE_ID_RAZER_BASILISK_ULTIMATE_RECEIVER:
    report = razer_chroma_extended_matrix_effect_wave(VARSTORE, LOGO_LED,
                                                      direction, 0x28);
    break;
 ...
 * Wave effect mode is activated whenever the file is written to
 */
ssize_t razer_attr_write_scroll_mode_wave(IOUSBDeviceInterface **usb_dev,
                                          const char *buf, size_t count) {
  unsigned char direction = (unsigned char)strtol(buf, NULL, 10);
  struct razer_report report = {0};
  ...
  case USB_DEVICE_ID_RAZER_BASILISK_ULTIMATE_RECEIVER:
    report = razer_chroma_extended_matrix_effect_wave(
        VARSTORE, SCROLL_WHEEL_LED, direction, 0x28);
    break;
 ...
 * Wave effect mode is activated whenever the file is written to
 */
ssize_t razer_attr_write_left_mode_wave(IOUSBDeviceInterface **usb_dev,
                                        const char *buf, size_t count) {
 ...
 * Wave effect mode is activated whenever the file is written to
 */
ssize_t razer_attr_write_right_mode_wave(IOUSBDeviceInterface **usb_dev,
                                         const char *buf, size_t count) {
 ...
 */
ssize_t razer_attr_write_logo_mode_static(IOUSBDeviceInterface **usb_dev,
                                          const char *buf, size_t count) {
  struct razer_report report = {0};
  ...
  if (count == 3) {
    ...
    case USB_DEVICE_ID_RAZER_ABYSSUS_V2:
      report = razer_chroma_standard_set_led_rgb(VARSTORE, LOGO_LED,
 ...
 * Set the mouse to static mode when 3 RGB bytes are written
 */
ssize_t razer_attr_write_scroll_mode_static(IOUSBDeviceInterface **usb_dev,
                                            const char *buf, size_t count) {
  struct razer_report report = {0};
  ...
  if (count == 3) {
    ...
    case USB_DEVICE_ID_RAZER_DEATHADDER_V2:
      report = razer_chroma_extended_matrix_effect_static(
          VARSTORE, SCROLL_WHEEL_LED, (struct razer_rgb *)&buf[0]);
      break;
    ...
    case USB_DEVICE_ID_RAZER_BASILISK_V3:
      ...
      break;
    case USB_DEVICE_ID_RAZER_ABYSSUS_V2:
      report = razer_chroma_standard_set_led_rgb(VARSTORE, SCROLL_WHEEL_LED,
                                                 (struct razer_rgb *)&buf[0]);
      report.transaction_id.id = 0x3F;
      break;
 ...
 * Wave effect mode is activated whenever the file is written to
 */
ssize_t razer_attr_write_left_mode_static(IOUSBDeviceInterface **usb_dev,
                                          const char *buf, size_t count) {
 ...
 */
ssize_t razer_attr_write_right_mode_static(IOUSBDeviceInterface **usb_dev,
                                           const char *buf, size_t count) {
 ...
 */
ssize_t
razer_attr_write_logo_mode_static_no_store(IOUSBDeviceInterface **usb_dev,
                                           const char *buf, size_t count) {
  struct razer_report report = {0};
  ...
  if (count == 3) {
    ...
    case USB_DEVICE_ID_RAZER_NAGA_HEX_V2:
      report = razer_chroma_mouse_extended_matrix_effect_static(
          NOSTORE, LOGO_LED, (struct razer_rgb *)&buf[0]);
      break;
    ...
    case USB_DEVICE_ID_RAZER_BASILISK_V3:
      ...
      break;
    case USB_DEVICE_ID_RAZER_ABYSSUS_V2:
      report = razer_chroma_standard_set_led_rgb(NOSTORE, LOGO_LED,
                                                 (struct razer_rgb *)&buf[0]);
      report.transaction_id.id = 0x1f;
      break;
 ...
 */
ssize_t
razer_attr_write_scroll_mode_static_no_store(IOUSBDeviceInterface **usb_dev,
                                             const char *buf, size_t count) {
  struct razer_report report = {0};
  ...
  if (count == 3) {
    ...
    case USB_DEVICE_ID_RAZER_NAGA_HEX_V2:
      report = razer_chroma_mouse_extended_matrix_effect_static(
          NOSTORE, SCROLL_WHEEL_LED, (struct razer_rgb *)&buf[0]);
      break;
    ...
    case USB_DEVICE_ID_RAZER_BASILISK_V3:
      ...
      break;
    case USB_DEVICE_ID_RAZER_ABYSSUS_V2:
      report = razer_chroma_standard_set_led_rgb(NOSTORE, SCROLL_WHEEL_LED,
                                                 (struct razer_rgb *)&buf[0]);
      report.transaction_id.id = 0x3F;
      break;
 ...
 */
ssize_t
razer_attr_write_left_mode_static_no_store(IOUSBDeviceInterface **usb_dev,
                                           const char *buf, size_t count) {
  return razer_attr_write_side_mode_static_no_store(usb_dev, buf, count,
                                                    LEFT_SIDE_LED);
}
 ...
 */
ssize_t
razer_attr_write_right_mode_static_no_store(IOUSBDeviceInterface **usb_dev,
                                            const char *buf, size_t count) {
  return razer_attr_write_side_mode_static_no_store(usb_dev, buf, count,
                                                    RIGHT_SIDE_LED);
}
 ...
 */
ssize_t razer_attr_write_logo_mode_spectrum(IOUSBDeviceInterface **usb_dev,
                                            const char *buf, size_t count) {
  struct razer_report report = {0};
  ...
  case USB_DEVICE_ID_RAZER_NAGA_HEX_V2:
    report =
        razer_chroma_mouse_extended_matrix_effect_spectrum(VARSTORE, LOGO_LED);
    break;
 ...
 * Spectrum effect mode is activated whenever the file is written to
 */
ssize_t razer_attr_write_scroll_mode_spectrum(IOUSBDeviceInterface **usb_dev,
                                              const char *buf, size_t count) {
  struct razer_report report = {0};
 ...
 * Spectrum effect mode is activated whenever the file is written to
 */
ssize_t razer_attr_write_left_mode_spectrum(IOUSBDeviceInterface **usb_dev,
                                            const char *buf, size_t count) {
  return razer_attr_write_side_mode_spectrum(usb_dev, buf, count,
                                             LEFT_SIDE_LED);
}
 ...
 * Spectrum effect mode is activated whenever the file is written to
 */
ssize_t razer_attr_write_right_mode_spectrum(IOUSBDeviceInterface **usb_dev,
                                             const char *buf, size_t count) {
  return razer_attr_write_side_mode_spectrum(usb_dev, buf, count,
                                             RIGHT_SIDE_LED);
}
 ...
 */
ssize_t razer_attr_write_logo_mode_breath(IOUSBDeviceInterface **usb_dev,
                                          const char *buf, size_t count) {
  struct razer_report report = {0};
  ...
  case USB_DEVICE_ID_RAZER_DEATHADDER_V2_MINI:
    ...
    default: // "Random" colour mode
      report = razer_chroma_extended_matrix_effect_breathing_random(VARSTORE,
                                                                    LOGO_LED);
      break;
    }
    break;
 ...
 * Sets breathing mode by writing 1, 3 or 6 bytes
 */
ssize_t razer_attr_write_scroll_mode_breath(IOUSBDeviceInterface **usb_dev,
                                            const char *buf, size_t count) {
  struct razer_report report = {0};
 ...
 * Sets breathing mode by writing 1, 3 or 6 bytes
 */
ssize_t razer_attr_write_left_mode_breath(IOUSBDeviceInterface **usb_dev,
                                          const char *buf, size_t count) {
 ...
 * Sets breathing mode by writing 1, 3 or 6 bytes
 */
ssize_t razer_attr_write_right_mode_breath(IOUSBDeviceInterface **usb_dev,
                                           const char *buf, size_t count) {
 ...
 */
ssize_t razer_attr_write_logo_mode_none(IOUSBDeviceInterface **usb_dev,
                                        const char *buf, size_t count) {
  struct razer_report report = {0};
 ...
 * No effect is activated whenever this file is written to
 */
ssize_t razer_attr_write_scroll_mode_none(IOUSBDeviceInterface **usb_dev,
                                          const char *buf, size_t count) {
  struct razer_report report = {0};
  ...
  case USB_DEVICE_ID_RAZER_NAGA_CHROMA:
  case USB_DEVICE_ID_RAZER_NAGA_HEX_V2:
    report = razer_chroma_mouse_extended_matrix_effect_none(VARSTORE,
                                                            SCROLL_WHEEL_LED);
    break;
  ...
  case USB_DEVICE_ID_RAZER_DEATHADDER_V2:
    report =
        razer_chroma_extended_matrix_effect_none(VARSTORE, SCROLL_WHEEL_LED);
    break;
 ...
 * No effect is activated whenever this file is written to
 */
ssize_t razer_attr_write_left_mode_none(IOUSBDeviceInterface **usb_dev,
                                        const char *buf, size_t count) {
 ...
 * No effect is activated whenever this file is written to
 */
ssize_t razer_attr_write_right_mode_none(IOUSBDeviceInterface **usb_dev,
                                         const char *buf, size_t count) {
 ...
 */
ssize_t razer_attr_write_scroll_led_effect(IOUSBDeviceInterface **usb_dev,
                                           const char *buf, size_t count) {
  unsigned char effect = (unsigned char)strtoul(buf, NULL, 10);
  struct razer_report report =
      razer_chroma_standard_set_led_effect(VARSTORE, SCROLL_WHEEL_LED, effect);
  report.transaction_id.id = 0x3F;
 ...
 */
ssize_t razer_attr_write_logo_led_effect(IOUSBDeviceInterface **usb_dev,
                                         const char *buf, size_t count) {
  unsigned char effect = (unsigned char)strtoul(buf, NULL, 10);
  struct razer_report report =
      razer_chroma_standard_set_led_effect(VARSTORE, LOGO_LED, effect);
  report.transaction_id.id = 0x3F;
 ...
 */
ssize_t razer_attr_write_logo_led_rgb(IOUSBDeviceInterface **usb_dev,
                                      const char *buf, size_t count) {
  struct razer_report report = {0};
 ...
 * should be written
 */
ssize_t razer_attr_write_logo_mode_reactive(IOUSBDeviceInterface **usb_dev,
                                            const char *buf, size_t count) {
  struct razer_report report = {0};
  ...
  if (count == 4) {
    ...
    case USB_DEVICE_ID_RAZER_NAGA_CHROMA:
    case USB_DEVICE_ID_RAZER_NAGA_HEX_V2:
      report = razer_chroma_mouse_extended_matrix_effect_reactive(
          VARSTORE, LOGO_LED, speed, (struct razer_rgb *)&buf[1]);
      break;
 ...
 * should be written
 */
ssize_t razer_attr_write_scroll_mode_reactive(IOUSBDeviceInterface **usb_dev,
                                              const char *buf, size_t count) {
  struct razer_report report = {0};
  ...
  if (count == 4) {
    ...
    case USB_DEVICE_ID_RAZER_NAGA_CHROMA:
      report = razer_chroma_mouse_extended_matrix_effect_reactive(
          VARSTORE, SCROLL_WHEEL_LED, speed, (struct razer_rgb *)&buf[1]);
      break;
...
ssize_t razer_attr_write_side_mode_reactive(IOUSBDeviceInterface **usb_dev,
                                            const char *buf, size_t count,
                                            int side) {
  struct razer_report report = {0};
  ...
  if (count == 4) {
    ...
    case USB_DEVICE_ID_RAZER_LANCEHEAD_WIRELESS_WIRED:
      report = razer_chroma_extended_matrix_effect_reactive(
          VARSTORE, side, speed, (struct razer_rgb *)&buf[1]);
      break;
    ...
    case USB_DEVICE_ID_RAZER_BASILISK_V2:
      ...
      break;
    default:
      printf("razermouse: left/right mode_reactive not supported for this "
             "model\n");
      return count;
    }
 ...
 * should be written
 */
ssize_t razer_attr_write_left_mode_reactive(IOUSBDeviceInterface **usb_dev,
                                            const char *buf, size_t count) {
  return razer_attr_write_side_mode_reactive(usb_dev, buf, count,
                                             LEFT_SIDE_LED);
}
 ...
 * should be written
 */
ssize_t razer_attr_write_right_mode_reactive(IOUSBDeviceInterface **usb_dev,
                                             const char *buf, size_t count) {
  return razer_attr_write_side_mode_reactive(usb_dev, buf, count,
                                             RIGHT_SIDE_LED);
}
...
ushort razer_attr_read_dpi(IOUSBDeviceInterface **usb_dev) {
  ...
  ushort dpi_x = (response.arguments[1] << 8) |
                 (response.arguments[2] &
                  0xFF); // Apparently the char buffer is rubbish, as buf[1]
...
void deathadder3_5g_set_poll_rate(IOUSBDeviceInterface **usb_dev,
                                  unsigned short poll_rate) {
  switch (poll_rate) {
  case 1000:
    da3_5g.poll = 1;
    break;
 ...
 * Sets the poll rate
 */
void razer_attr_write_poll_rate(IOUSBDeviceInterface **usb_dev,
                                ushort polling_rate) {
  ...
  case USB_DEVICE_ID_RAZER_OROCHI_2011:
    ...
    report = razer_chroma_misc_set_orochi2011_poll_dpi(
        orochi2011_poll, orochi2011_dpi, orochi2011_dpi);
    break;
...
void razer_attr_write_matrix_brightness(IOUSBDeviceInterface **usb_dev,
  ...
  case USB_DEVICE_ID_RAZER_NAGA_HEX_V2:
    report = razer_chroma_standard_set_led_brightness(VARSTORE, BACKLIGHT_LED,
                                                      brightness);
    report.transaction_id.id = 0x3f;
    break;
  ...
  case USB_DEVICE_ID_RAZER_BASILISK_V3:
    report =
        razer_chroma_extended_matrix_brightness(VARSTORE, 0x00, brightness);
    report.transaction_id.id = 0x1F;
    break;
...
ushort razer_attr_read_matrix_brightness(IOUSBDeviceInterface **usb_dev) {
  ...
  case USB_DEVICE_ID_RAZER_OROCHI_CHROMA:
    // Orochi sets brightness of scroll wheel apparently
    report =
        razer_chroma_standard_get_led_brightness(VARSTORE, SCROLL_WHEEL_LED);
    break;
...
ushort razer_attr_read_scroll_led_brightness(IOUSBDeviceInterface **usb_dev) {
  ...
  case USB_DEVICE_ID_RAZER_BASILISK_V3:
    report =
        razer_chroma_extended_matrix_get_brightness(VARSTORE, SCROLL_WHEEL_LED);
    report.transaction_id.id = 0x1f;
    break;
 ...
 */
void razer_attr_write_scroll_led_brightness(IOUSBDeviceInterface **usb_dev,
                                            unsigned char brightness) {
  struct razer_report report = {0};
  ...
  case USB_DEVICE_ID_RAZER_BASILISK_V2:
  case USB_DEVICE_ID_RAZER_BASILISK_V3:
    report = razer_chroma_extended_matrix_brightness(VARSTORE, SCROLL_WHEEL_LED,
                                                     brightness);
    report.transaction_id.id = 0x1f;
    break;
 ...
 */
void razer_attr_write_logo_led_brightness(IOUSBDeviceInterface **usb_dev,
                                          unsigned char brightness) {
  struct razer_report report = {0};
  ...
  case USB_DEVICE_ID_RAZER_BASILISK_V3:
    report =
        razer_chroma_extended_matrix_brightness(VARSTORE, LOGO_LED, brightness);
    report.transaction_id.id = 0x1f;
    break;
...
ushort razer_attr_read_side_led_brightness(IOUSBDeviceInterface **usb_dev,
                                           int side) {
  struct razer_report report = {0};
  struct razer_report response = {0};
...
void razer_attr_write_side_led_brightness(IOUSBDeviceInterface **usb_dev,
                                          unsigned char brightness, int side) {
  struct razer_report report = {0};
  ...
  case USB_DEVICE_ID_RAZER_LANCEHEAD_WIRELESS_WIRED:
    report =
        razer_chroma_extended_matrix_brightness(VARSTORE, side, brightness);
    break;
  ...
  case USB_DEVICE_ID_RAZER_BASILISK_V3:
    report = razer_chroma_extended_matrix_brightness(
        VARSTORE, BASILISK_V3_BASE_LED, brightness);
    report.transaction_id.id = 0x1f;
    break;

  default:
    report =
        razer_chroma_standard_set_led_brightness(VARSTORE, side, brightness);
    break;
  }
 ...
 */
void razer_attr_write_left_led_brightness(IOUSBDeviceInterface **usb_dev,
                                          unsigned char brightness) {
  return razer_attr_write_side_led_brightness(usb_dev, brightness,
                                              LEFT_SIDE_LED);
}
 ...
 */
void razer_attr_write_right_led_brightness(IOUSBDeviceInterface **usb_dev,
                                           unsigned char brightness) {
  return razer_attr_write_side_led_brightness(usb_dev, brightness,
                                              RIGHT_SIDE_LED);
}
...
ssize_t razer_attr_read_device_serial(IOUSBDeviceInterface **usb_dev,
  ...
  response_report = razer_send_payload(usb_dev, &report);
  strncpy(&serial_string[0], (char *)&response_report.arguments[0], 22);
  serial_string[22] = '\0';
